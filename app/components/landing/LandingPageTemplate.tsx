        ...
        <div className="max-w-[1200px] mx-auto px-5 relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="text-white text-center md:text-left">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold leading-tight mb-4 text-white drop-shadow-lg uppercase">
                {data.hero.preHeading}
              </h1>
              <h4 className="text-xl md:text-2xl font-bold text-vlcc-orange mb-6 tracking-wide font-heading">
                {data.hero.headingPrefix} <span className="text-white">{data.hero.headingHighlight}</span>
              </h4>
