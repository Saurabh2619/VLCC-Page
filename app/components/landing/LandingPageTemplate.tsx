...
export default function LandingPageTemplate({ data }: { data: LandingPageData }) {
  ...
  return (
    <main className="min-h-screen font-body bg-white">
      ...
      <footer className="bg-[#121212] text-white py-10 border-t border-white/10 relative z-10">
