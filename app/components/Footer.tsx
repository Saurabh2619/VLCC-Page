        ...
        <div className="flex justify-between flex-wrap gap-[50px] mb-[60px] border-b border-[#333] pb-[60px] flex-col md:flex-row">
          ...
          <div className="flex-1 min-w-[200px] w-full md:w-auto">
            ...
            <div className="flex gap-[15px]">
              ...
              <a href="https://www.instagram.com/vlcc_schoolofbeauty/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#222] rounded-full flex items-center justify-center text-white transition-all duration-300 hover:bg-[#bc1888] hover:-translate-y-[3px]" aria-label="Instagram">
              ...
              <a href="https://api.whatsapp.com/send?phone=919560554693&text=" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#222] rounded-full flex items-center justify-center text-white transition-all duration-300 hover:bg-[#25D366] hover:-translate-y-[3px]" aria-label="WhatsApp">
