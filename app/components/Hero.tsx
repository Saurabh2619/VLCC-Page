...
export default function Hero() {
  return (
    <section id="hero" className="relative min-h-[100dvh] md:min-h-screen flex items-center bg-[url('https://images.unsplash.com/photo-1522337660859-02fbefca4702?q=80&w=2069&auto=format&fit=crop')] bg-cover bg-center bg-fixed pt-[95px] pb-[70px] md:py-[100px] overflow-hidden text-white">
          ...
          <div className="flex-1 min-w-[300px] animate-slide-up w-full mt-4 md:mt-0">
            ...
            <div className="flex gap-4 md:gap-[30px] justify-center md:justify-start flex-wrap">
              <div className="flex items-center gap-3 md:gap-[15px]">
                <div className="w-[45px] h-[45px] md:w-[50px] md:h-[50px] bg-white/10 rounded-full flex items-center justify-center text-xl md:text-2xl border border-white/20 shadow-sm">📍</div>
                <div className="text-left">
                  <h4 className="text-sm md:text-base font-semibold font-heading mb-0 md:mb-1">On-Campus</h4>
                  <p className="text-[11px] md:text-sm text-[#aaa] font-body">Delhi-NCR</p>
                </div>
              </div>
              <div className="flex items-center gap-3 md:gap-[15px]">
                <div className="w-[45px] h-[45px] md:w-[50px] md:h-[50px] bg-white/10 rounded-full flex items-center justify-center text-xl md:text-2xl border border-white/20 shadow-sm">🏆</div>
                <div className="text-left">
                  <h4 className="text-sm md:text-base font-semibold font-heading mb-0 md:mb-1">Approved by</h4>
                  <p className="text-[11px] md:text-sm text-[#aaa] font-body">NSDC</p>
                </div>
              </div>
            </div>
          </div>

          <div className="flex-none md:flex-[0_1_450px] w-full animate-fade-in mt-2 md:mt-0">
            <div className="glass-panel p-6 md:p-[40px] bg-[#141414]/40 rounded-2xl">
              <h3 className="text-2xl text-white mb-2 font-heading font-semibold text-left">Request a Call Back</h3>
              <p className="text-[#bbb] text-xs md:text-sm mb-5 md:mb-[25px] text-left">Fill in Your Details to Get Started</p>
